...
> **Spikes:** Signal rail (#106) · Attention field (#112) · Pipeline agent graph (#118) · Doctor panel (#124) · Gov audit (#127) — presence panels tied to real MCP/chat signals. Does **not** fully unpark #37.  
> **Design mirror (implemented only):** [Figma — Companion surface](https://www.figma.com/design/ZSv9VMBAFkEo908kQtBuwi) — frames: First glance · Process open · Doctor · Gov audit · tracking [#120](https://github.com/KleilsonSantos/aios-companion/issues/120)  
...
Today Companion is CLI + chat + caps + doctor + surface. Presence spikes so far: **Signal rail** (#106), **Attention field** (#112), **Pipeline agent graph** (#118), **Doctor panel** (#124), **Gov audit** (#127) — all CSS-only and tied to real control-plane signals. A **Figma mirror** tracks shipped UI only ([#120](https://github.com/KleilsonSantos/aios-companion/issues/120)) — populated through **v0.17.0** (First glance · Process open · Doctor · [Gov audit](https://www.figma.com/design/ZSv9VMBAFkEo908kQtBuwi?node-id=9-2)); never invent cinema ahead of code. Full cinematic layer remains parked until more spikes meet the criteria above.
